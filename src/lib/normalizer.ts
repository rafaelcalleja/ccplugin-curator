 ...
 */
export async function normalizePlugin(pluginPath: string): Promise<NormalizedPlugin> {
 ...
 */
export async function autoDiscoverCommands(pluginPath: string): Promise<string[]> {
 ...
 */
export async function autoDiscoverAgents(pluginPath: string): Promise<string[]> {
 ...
 */
export async function autoDiscoverSkills(pluginPath: string): Promise<string[]> {
 ...
 */
async function parseComponentPaths(
  pluginPath: string,
  pathConfig: string | string[] | undefined,
  globPattern: string,
  returnDirs: boolean = false
): Promise<string[]> {
  if (!pathConfig) {
    return [];
  }
...
export async function parseHooks(
  pluginPath: string,
  hooksConfig: string | object | undefined
): Promise<Array<{
  event: string;
  type: 'command';
  command: string;
 ...
 */
export async function parseMcps(
  pluginPath: string,
  mcpConfig: string | object | undefined
): Promise<Array<{
  name: string;
  command: string;
  args?: string[];
